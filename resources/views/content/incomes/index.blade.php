    ...
    <div class="row gy-4">
        ...
        <div class="col-md-12 col-lg-4">
            <div class="card" style="height: 100%; display: flex; flex-direction: column; flex:1;">
                <div class="card-body">
                    <h4 class="card-title mb-1">Catatan Pemasukan</h4>
                    <p class="pb-0">Catat semua Pemasukanmu ! </p>
                    {{-- <h4 class="text-primary mb-1">$42.8k</h4> --}}
                    {{-- <p class="mb-2 pb-1">78% of target 🚀</p> --}}
                    <a href={{url("/incomes/create")}} class="btn btn-sm btn-success">Tambah Pemasukan</a>
                </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">Rekap Pemasukan</h5>
                        <div class="dropdown">
        ...
        <div class="col-12">
            <div class="card">
                <h5 class="card-header">Riwayat Pemasukan</h5>
                    ...
                    <table id="example" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end" style="white-space: nowrap">Rp. {{ number_format($income->amount, 2, '.', ',') }} </td>
                                <td class="text-center">{{ $income->source->name }}</td>
                                <td class="text-left" style="white-space: nowrap"><i class="mdi mdi-{{ $income->card->icon }} mdi-10px" style="color: {{ $income->card->color}}"></i> {{ $income->card->name }}</td>
                                <td class="text-center">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mx-1">
                                            <a href="/incomes/{{ $income->id }}" class="avatar-initial bg-info rounded shadow">
                                                <i class="mdi mdi-eye mdi-10px"></i>
                                            </a>
                                        </div>
                                        <div class="avatar mx-1">
                                            <a href="/incomes/{{ $income->id }}/edit" class="avatar-initial bg-warning rounded shadow">
                                                <i class="mdi mdi-pencil mdi-10px"></i>
                                            </a>
                                        </div>
                                        <div class="avatar mx-1">
                                            <form action="/incomes/{{ $income->id }}" method="post" class='d-inline'>
                                                @method('delete')
                                                @csrf
