...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-4 gap-2 gap-lg-0">
      ...
      <li class="nav-item"><a class="nav-link" href="{{url('subtypes')}}"><i class="mdi mdi-file-tree mdi-20px me-1"></i> Sub-Kategori</a></li>
      <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="mdi mdi-currency-usd mdi-20px me-1"></i> Sumber Pemasukan</a></li>
    </ul>
    <div class="card">
      <!-- Types -->
      <h5 class="card-header">List Sumber Pemasukan</h5>
      <div class="card-body">
        <div class="row">
            <div class="col-sm-7">
                    ...
                    <table id="expenses_table" class="table">
                        <thead class="table-dark">
                            <tr>
                                ...
                                <th class="text-truncate">Sumber Pemasukan</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-left">{{ $source->name }}</td>
                                <td class="text-left" style="white-space: nowrap">
                                    <i class="mdi mdi-{{ $source->icon }} mdi-10px"></i> {{ $source->icon }} </span>
                                </td>
                                {{-- <td class="text-left" style="white-space: nowrap">
                                    <p><span class="badge bg-{{ $source->color }}" style="background-color: {{ $source->color }}">  &nbsp; </span> : "{{ $source->color }}"</p>
                                </td> --}}
                                <td class="text-center">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mx-1">
                                            <a href="/sources/{{ $source->id }}/edit" class="avatar-initial bg-warning rounded shadow">
                                                <i class="mdi mdi-pencil mdi-10px"></i>
                                            </a>
                                        </div>
                                        <div class="avatar mx-1">
                                            <form action="/sources/{{ $source->id }}" method="post" class='d-inline'>
                                                @method('delete')
                                                @csrf
                        ...
                        <tfoot>
                            <tr>
                                <td>
                                    <div class="avatar mx-1">
                                        <a href="/sources/create" class="avatar-initial bg-grey rounded shadow">
