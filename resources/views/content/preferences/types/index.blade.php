...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-4 gap-2 gap-lg-0">
      <li class="nav-item"><a class="nav-link active" href="javascript:void(0);"><i class="mdi mdi-tune mdi-20px me-1"></i> Kategori</a></li>
                    ...
                    <table id="expenses_table" class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-left">{{ $type->name }}</td>
                                <td class="text-left" style="white-space: nowrap">
                                    <i class="mdi mdi-{{ $type->icon }} mdi-10px"></i> {{ $type->icon }} </span>
                                </td>
                                <td class="text-left" style="white-space: nowrap">
                                    <p><span class="badge bg-{{ $type->color }}" style="background-color: {{ $type->color }}">  &nbsp; </span> : "{{ $type->color }}"</p>
                                </td>
                                <td class="text-center">{{ $type->percentage }}</td>
                                <td class="text-center">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar mx-1">
                                            <a href="/types/{{ $type->id }}/edit" class="avatar-initial bg-warning rounded shadow" data-toggle="modal" data-target="#editModal" data-id="{{ $type->id }}">
                        ...
                        <tfoot>
                            <tr>
                                <td>
                                    <div class="avatar mx-1">
                                        <a href="/types/create" class="avatar-initial bg-grey rounded shadow">
