    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        @csrf
          ...
          <div class="form-floating form-floating-outline mb-4">
            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Transaksi" name="title" value="{{ old('title') }}"/>
          ...
          <div class="input-group mb-4">
            ...
            <input type="file" class="form-control" id="invoice" name="image" enctype="multipart/form-data">
          </div>
